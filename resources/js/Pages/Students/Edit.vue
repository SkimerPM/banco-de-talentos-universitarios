    ...
    <Layout>
        <div class="max-w-2xl mx-auto">
            <div class="mb-6">
                ...
                <h1 class="mt-4 text-2xl font-bold text-gray-900">Editar Estudiante</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
                ...
                <div>
                    ...
                    <div v-if="student.photo && !form.photo" class="mb-2">
                        <img :src="`/storage/${student.photo}`" class="w-16 h-16 rounded-full object-cover border border-gray-200" />
                    </div>
