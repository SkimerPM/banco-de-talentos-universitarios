    ...
    <Layout>
        <div class="max-w-2xl mx-auto">
            <div class="mb-6">
                ...
                <h1 class="mt-4 text-2xl font-bold text-gray-900">Editar Proyecto</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
                ...
                <div>
                    ...
                    <div v-if="project.image && !form.image" class="mb-2">
                        <img :src="`/storage/${project.image}`" class="w-32 h-20 object-cover rounded-lg border border-gray-200" />
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="form.repository_url" type="url" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                    ...
                    <div>
                        ...
                        <input v-model="form.demo_url" type="url" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
